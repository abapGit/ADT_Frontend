...
public class Messages extends NLS {
	...
	public static String AbapGitWizardPageApack_label_description;
	public static String AbapGitWizardPageApack_label_git_repository_url;
	public static String AbapGitWizardPageApack_label_license;
	public static String AbapGitWizardPageApack_label_organization_id;
	public static String AbapGitWizardPageApack_label_package_id;
