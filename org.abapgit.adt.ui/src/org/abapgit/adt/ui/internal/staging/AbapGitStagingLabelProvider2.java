...
public class AbapGitStagingLabelProvider2 extends StyledCellLabelProvider {
	...
	public void update(ViewerCell cell) {
		...
		} else if (cell.getElement() instanceof AbapGitStagingGroupNode) {
			AbapGitStagingGroupNode object = (AbapGitStagingGroupNode) cell.getElement();
	...
	private void updateGroupNodeCell(ViewerCell cell, AbapGitStagingGroupNode object) {
		StyledString text = new StyledString();
		text.append(object.getValue());
		cell.setText(text.getString());

		if (object.getType().equals("Package")) {
		...
		if (object.getType().equals("Transport")) {
			cell.setImage(com.sap.adt.tools.core.ui.Activator.getDefault()
