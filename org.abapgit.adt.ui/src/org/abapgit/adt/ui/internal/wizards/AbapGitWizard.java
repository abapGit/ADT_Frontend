...
public class AbapGitWizard extends Wizard {
	...
	public void addPages() {
		...
		this.pageBranchAndPackage = new AbapGitWizardPageBranchAndPackage(this.project, this.destination, this.cloneData,
				false);
		this.pageFolderlogic = new AbapGitWizardPageFolderLogic(this.project, this.destination, this.cloneData, false);
...
//			if (this.cloneData.folderLogic != null && !this.cloneData.folderLogic.isEmpty()) {
...
//				return super.getNextPage(page);
//			}
//		} else if (page.equals(this.pageFolderlogic) && !this.cloneData.hasDependencies()) {
//				// If we don't have APACK dependencies, we can skip the APACK-related page
//				return this.transportPage;
//			}
//			return super.getNextPage(page);
