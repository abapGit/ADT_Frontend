...
public class AbapGitWizardBranchSelection extends Wizard {
	...
	AbapGitWizardPageBranchAndPackage pageBranchAndPackage;
			...
			PlatformUI.getWorkbench().getProgressService().run(true, true, new IRunnableWithProgress() {
				...
				public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
					...
					if (packageServiceUI.packageExists(AbapGitWizardBranchSelection.this.destination, packageName, monitor)) {
						List<IAdtObjectReference> packageRefs = packageServiceUI.find(AbapGitWizardBranchSelection.this.destination, packageName,
								monitor);
				...
				public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
					...
					RepositoryServiceFactory
							.createRepositoryService(
									AbapGitWizardBranchSelection.this.abapGitService.getDestination(AbapGitWizardBranchSelection.this.project), monitor)
					...
					repoService.cloneRepository(AbapGitWizardBranchSelection.this.selRepoData.getUrl(),
							...
							AbapGitWizardBranchSelection.this.cloneData.user, AbapGitWizardBranchSelection.this.cloneData.pass, monitor).getAbapObjects();
//
				}
			});
