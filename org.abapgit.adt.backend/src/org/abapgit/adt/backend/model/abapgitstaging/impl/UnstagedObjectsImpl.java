...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Unstaged Objects</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.abapgit.adt.backend.model.abapgitstaging.impl.UnstagedObjectsImpl#getAbapgitobject <em>Abapgitobject</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnstagedObjectsImpl extends MinimalEObjectImpl.Container implements IUnstagedObjects {
	/**
	...
	protected EClass eStaticClass() {
		return IAbapgitstagingPackage.Literals.UNSTAGED_OBJECTS;
	}
	...
	public EList<IAbapGitObject> getAbapgitobject() {
		if (abapgitobject == null) {
			abapgitobject = new EObjectContainmentEList<IAbapGitObject>(IAbapGitObject.class, this, IAbapgitstagingPackage.UNSTAGED_OBJECTS__ABAPGITOBJECT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IAbapgitstagingPackage.UNSTAGED_OBJECTS__ABAPGITOBJECT:
