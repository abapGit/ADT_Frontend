...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ignored Objects</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.abapgit.adt.backend.model.abapgitstaging.impl.IgnoredObjectsImpl#getAbapgitobject <em>Abapgitobject</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IgnoredObjectsImpl extends MinimalEObjectImpl.Container implements IIgnoredObjects {
	/**
	...
	protected EClass eStaticClass() {
		return IAbapgitstagingPackage.Literals.IGNORED_OBJECTS;
	}
	...
	public EList<IAbapGitObject> getAbapgitobject() {
		if (abapgitobject == null) {
			abapgitobject = new EObjectContainmentEList<IAbapGitObject>(IAbapGitObject.class, this, IAbapgitstagingPackage.IGNORED_OBJECTS__ABAPGITOBJECT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IAbapgitstagingPackage.IGNORED_OBJECTS__ABAPGITOBJECT:
