 ...
 * @generated
 */
public class AbapgitrepositoriesSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public AbapgitrepositoriesSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IAbapgitrepositoriesPackage.REPOSITORY: {
				IRepository repository = (IRepository)theEObject;
				T result = caseRepository(repository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IAbapgitrepositoriesPackage.REPOSITORIES: {
				IRepositories repositories = (IRepositories)theEObject;
				T result = caseRepositories(repositories);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IAbapgitrepositoriesPackage.DOCUMENT_ROOT: {
	 ...
	 * @generated
	 */
	public T caseRepositories(IRepositories object) {
		return null;
	}
