 ...
 *   <li>{@link org.abapgit.adt.backend.model.abapgitrepositories.impl.RepositoryImpl#getFirstCommit <em>First Commit</em>}</li>
...
public class RepositoryImpl extends MinimalEObjectImpl.Container implements IRepository {
	 ...
	 * @ordered
	 */
	protected static final String FIRST_COMMIT_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getFirstCommit() <em>First Commit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFirstCommit()
	 * @generated
	 * @ordered
	 */
	protected String firstCommit = FIRST_COMMIT_EDEFAULT;
	 ...
	 */
	@Override
	public void setFirstCommit(String newFirstCommit) {
		String oldFirstCommit = firstCommit;
		firstCommit = newFirstCommit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IAbapgitrepositoriesPackage.REPOSITORY__FIRST_COMMIT, oldFirstCommit, firstCommit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case IAbapgitrepositoriesPackage.REPOSITORY__FIRST_COMMIT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case IAbapgitrepositoriesPackage.REPOSITORY__REMOTE_PASSWORD:
				...
				return;
			case IAbapgitrepositoriesPackage.REPOSITORY__FIRST_COMMIT:
				setFirstCommit((String)newValue);
				return;
			case IAbapgitrepositoriesPackage.REPOSITORY__TRANSPORT_REQUEST:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case IAbapgitrepositoriesPackage.REPOSITORY__FIRST_COMMIT:
				return FIRST_COMMIT_EDEFAULT == null ? firstCommit != null : !FIRST_COMMIT_EDEFAULT.equals(firstCommit);
			case IAbapgitrepositoriesPackage.REPOSITORY__TRANSPORT_REQUEST:
